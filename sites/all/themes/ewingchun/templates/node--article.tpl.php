	...
	<div class="articalmain">
		...
		<div class="middle">
			...
			<div class="middleleft">
				...
				<div class="middleleftimg1"> <a href="<?php echo $node->field_embeded_video['und'][0]['video_url']?>" rel="lightvideo[|width:400px; height:300px;]" class="emvideo-thumbnail-replacement" ><span></span>111111<img src="http://img.youtube.com/vi/<?php print file_create_url($node->field_embeded_video['und'][0]['thumbnail_path']) ?>" /></a>
					<?php 
