	...
	<div class="articalmain">
		...
		<div class="middle">
			...
			<div class="middleleft">
				...
				<div class="clear-left"></div>
				<!-- clear the floating elements -->
				<div class="middleleftimg1"><a href="http://www.youtube.com/watch?v=3fisJ-Pg0wA" rel="lightvideo[|width:640px; height:480px;]" class="lightvideo emvideo-thumbnail-replacement" ><span></span><img src="<?php print file_create_url($node->field_embeded_video['und'][0]['thumbnail_path']) ?>" /></a>
					<?php 
