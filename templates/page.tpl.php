    ...
    <?php if ($page['footer'] || $attribution): ?>
      <footer<?php print $footer_attributes; ?>>
        <?php print render($page['footer']); ?>
          <p><strong>eWingChun.com is your educational and research super-site for learning about Wing Chun Kung Fu.
</strong></p>
<p class="copyright">Copyright 2012 © Everything Wing Chun (tm). All Rights Reserved. Everything Wing Chun is a registered trademark of Everything Wing Chun, LLC.</p>
